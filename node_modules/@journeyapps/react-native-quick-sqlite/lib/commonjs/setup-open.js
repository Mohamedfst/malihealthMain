...
exports.setupOpen = setupOpen;
var _types = require("./types");
var _utils = require("./utils");
var _DBListenerManager = require("./DBListenerManager");
    ...
    try {
      ...
      await record?.callback({
        ...
        execute: async (sql, args) => {
          ...
          (0, _utils.enhanceQueryResult)(result);
          return result;
        }
      });
    } catch (ex) {
...
function setupOpen(QuickSQLite) {
  ...
  return {
    ...
    open: (dbName, options = {}) => {
      ...
      const listenerManager = new _DBListenerManager.DBListenerManagerInternal({
        dbName
      });
      ...
      const readLock = (callback, options) => requestLock(_types.ConcurrentLockType.READ, callback, options);
      const writeLock = (callback, options) => requestLock(_types.ConcurrentLockType.WRITE, callback, options, {
        lockReleased: async () => {
